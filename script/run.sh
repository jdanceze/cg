...
while read apk_path; do
    ...
    echo "initial emu..."
    timeout 60s /workspace/sapienz-d0f06c30800332bbafa7cf0ed32379fe1abcad5d/clear.sh
    ...
    echo $apk_path >> /workspace/running_apk.txt
    timeout 1800s python2 /workspace/sapienz-d0f06c30800332bbafa7cf0ed32379fe1abcad5d/main.py $out_directory/instrumented.apk
